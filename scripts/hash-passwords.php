...
/**
 * Еднократна миграция: хешира всички пароли в таблица `user`, които
 * все още са в чист текст (или стар алгоритъм). Безопасно е да се пуска
 * многократно — вече хешираните пароли се пропускат.
 *
 * Употреба:
